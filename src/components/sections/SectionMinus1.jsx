  ...
  const [graphData] = useState({
    ...
    links: [
      ...
      },
      {
        ...
        target: "Microsoft",
        value: 3,
        label: "Market Rivalry",
      },
      {
        source: "DeepSeek",
        target: "Google",
        value: 3,
        label: "Tech Competition",
      },
      {
        source: "DeepSeek",
        target: "Investors",
...
function SectionMinus1() {
  ...
  const notice = {
    short:
      "ADVISORY: This is a fast-moving story with ongoing developments, current as of the time of release, with its full impact still unfolding.",
    full: "This story is evolving rapidly with far-reaching implications. DeepSeek-R1’s impact is still unfolding, and our coverage highlights key trends rather than providing a final analysis. As new information emerges, perspectives and risks will continue to develop. We encourage readers to stay informed as the landscape shifts.",
  };
  ...
  const resources = [
    {
      title: "Research Paper",
      description:
        "DeepSeek's official research paper, titled 'DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning,' details the model's development and capabilities.",
      link: "https://arxiv.org/abs/2501.12948",
      icon: FileText,
      category: "Official Releases",
    },
    {
      title: "GitHub Repository",
      description:
        "The official DeepSeek-R1 code repository is available on GitHub, providing access to the model's code and technical documentation.",
      link: "https://github.com/deepseek-ai/DeepSeek-R1",
      icon: Github,
      category: "Official Releases",
    },
    {
      title: "Technical Report",
      description:
        "The technical report for DeepSeek-R1 is accessible within the GitHub repository, offering in-depth insights into the model's architecture and training methodology.",
      link: "https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf",
      icon: BookOpen,
      category: "Technical Documentation",
    },
    {
      title: "Industry Analysis",
      description:
        "An article from The Atlantic provides an in-depth analysis of DeepSeek-R1's impact on the AI industry, comparing it to models from OpenAI and discussing its implications for global AI development.",
      link: "https://www.theatlantic.com/technology/archive/2025/01/deepseek-china-ai/681481/",
      icon: BarChart,
      category: "Assessments and Comparisons",
    },
    {
      title: "Technical Breakdown",
      description:
        "A video titled 'A Slightly Technical Breakdown of DeepSeek-R1' offers a detailed examination of the model's architecture and performance.",
      link: "https://www.youtube.com/watch?v=CiS9gDfYZ-w&utm_source=chatgpt.com",
      icon: Video,
      category: "Assessments and Comparisons",
    },
  ...
  const sections = [
    {
      ...
      title: "Technological Breakthroughs",
      content:
        "DeepSeek-R1 has emerged as a major competitor to Western AI models, demonstrating advanced reasoning capabilities while achieving top ranking on Apple's App Store. Developed at a fraction of the cost of its competitors, it challenges traditional AI scaling assumptions.",
      highlight: "DeepSeek-R1 Innovation",
    },
    {
      icon: Code,
      title: "Open Source Approach",
      content:
        "Unlike many proprietary AI models, DeepSeek has embraced an open-source strategy, making its model weights, code, and research openly available. This approach has accelerated global collaboration while sparking regulatory and security debates.",
      highlight: "Open Innovation",
    },
    {
      icon: TrendingDown,
      title: "Market Disruptions",
      content:
        "DeepSeek-R1’s release triggered market volatility, causing sharp declines in tech stocks, including Nvidia, Microsoft, and Alphabet. The event has intensified discussions about AI infrastructure investments and the long-term viability of proprietary models.",
      highlight: "Global Impact",
    },
    {
      icon: Briefcase,
      title: "Strategic Industry Responses",
      content:
        "Tech giants like OpenAI, Microsoft, and Meta have moved quickly to counter DeepSeek’s unexpected competitive pressure. Responses include accelerated product rollouts, increased investment in open-source alternatives, and strategic realignments in AI development.",
      highlight: "AI Industry Shift",
    },
    {
      icon: Shield,
      title: "Geopolitical and Security Concerns",
      content:
        "DeepSeek’s rapid adoption has raised concerns over AI governance, data security, and national security risks. U.S. officials have flagged potential risks linked to AI-driven data collection and China’s expanding role in the global AI race.",
      highlight: "AI and National Security",
    },
    {
      icon: Flame,
      title: "Backlash and Controversies",
      content:
        "DeepSeek-R1 has ignited debates on AI ethics, data privacy, and potential censorship in model outputs. While some praise its accessibility, critics warn of misuse, model bias, and regulatory gaps in governing powerful open-source AI.",
      highlight: "AI Ethics & Public Debate",
    },
  ];
    ...
    <div className="p-4 space-y-8">
      ...
      <div className="bg-blue-300 p-8 border-b border-gray-200 mb-6">
        ...
        >
          ...
          <p className="text-gray-700">
            DeepSeek AI Development: 4th Week January 2025
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <h4 className="text-l font-semibold mb-4">
            DeepSeek-R1’s Disruptive Emergence and Global Impact:
          </h4>

          <p className="text-gray-600">
            DeepSeek-R1, a <strong>Chinese-developed</strong>, open-source AI
            model, has rapidly reshaped the AI landscape, sparking{" "}
            <strong>market turmoil</strong>,{" "}
            <strong>industry realignment</strong>,{" "}
            <strong>geopolitical scrutiny</strong>, and{" "}
            <strong>regulatory debates</strong>. The model, released on{" "}
            <strong>January 20, 2025</strong>, quickly gained traction for its{" "}
            <strong>high reasoning capabilities</strong> while being developed
            at a fraction of the cost of its Western counterparts. Its rapid
            adoption—topping the <strong>U.S. App Store</strong>—triggered{" "}
            <strong>stock market declines</strong> for major AI-driven
            companies, including <strong>Nvidia</strong>,{" "}
            <strong>Microsoft</strong>, and <strong>Alphabet</strong>. <br />
            <br />
          </p>

          <p className="text-gray-600">
            As <strong>DeepSeek’s influence</strong> grows, so do{" "}
            <strong>national security concerns</strong> in the{" "}
            <strong>U.S.</strong>, with the <strong>White House</strong>{" "}
            reviewing potential risks and the <strong>U.S. Navy</strong> banning
            the app on security grounds. Meanwhile,{" "}
            <strong>privacy advocates</strong> have raised alarms over{" "}
            <strong>data governance</strong> and{" "}
            <strong>censorship risks</strong>, prompting discussions on{" "}
            <strong>AI regulation</strong>. Industry leaders are recalibrating
            strategies, with <strong>OpenAI</strong>, <strong>Microsoft</strong>
            , and <strong>Alibaba</strong> responding to the{" "}
            <strong>unexpected competitive pressure</strong>. The story remains{" "}
            <strong>fast-moving</strong>, with implications for{" "}
            <strong>global AI leadership</strong>,{" "}
            <strong>economic investments</strong>, and{" "}
            <strong>regulatory policies</strong> still unfolding.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3 text-gray-600 mb-4">
            <li>
              <strong>AI Market Disruption:</strong> DeepSeek’s rapid success
              has forced a reassessment of AI investment strategies, raising
              competitive pressure on incumbents like OpenAI and Microsoft.
            </li>
            <li>
              <strong>Global AI Power Shift:</strong> DeepSeek’s emergence
              challenges U.S. dominance in AI, with China solidifying its
              influence in AI research and development.
            </li>
            <li>
              <strong>Security & Regulation Risks:</strong> The U.S. government
              has begun evaluating AI national security concerns, with potential
              regulatory actions on the horizon.
            </li>
            <li>
              <strong>Backlash & Ethical Questions:</strong> Data privacy
              concerns, potential censorship issues, and AI safety
              vulnerabilities remain under scrutiny.
            </li>
          </ul>

          <h4 className="text-l font-semibold mb-4">
            The situation remains fluid. DeepSeek-R1’s trajectory continues to
            evolve, with policy responses, technological adaptations, and market
            shifts shaping the next phase.
          </h4>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <h4 className="text-l font-semibold mb-4">
            Summary: DeepSeek-R1's Disruptive Emergence and Global Impact
          </h4>

          <p className="text-gray-600">
            DeepSeek-R1 has{" "}
            <strong>fundamentally disrupted the AI landscape</strong> by
            delivering <strong>state-of-the-art performance</strong> at a{" "}
            <strong>fraction of the cost and time</strong> of its competitors.
            Its <strong>low-cost, high-efficiency model</strong> has triggered a{" "}
            <strong>$1 trillion market cap loss</strong>, with{" "}
            <strong>Nvidia alone losing $593B</strong>. The model’s{" "}
            <strong>open-source approach</strong> is accelerating{" "}
            <strong>global AI collaboration</strong> while raising{" "}
            <strong>national security</strong> and{" "}
            <strong>regulatory concerns</strong>. With{" "}
            <strong>20-50x lower operational costs</strong> and{" "}
            <strong>faster deployment</strong>, DeepSeek-R1 is{" "}
            <strong>
              reshaping AI economics, industry strategy, and geopolitical
              competition
            </strong>{" "}
            in real time.
            <br />
            ...
            <div className="bg-gray-50 p-3 rounded-lg border-l-4 border-red-500">
              ...
              <div className="flex justify-between items-center gap-2">
                <div className="text-center flex-1">
                  <div className="text-3xl font-bold text-blue-600">$1T</div>
                  <div className="text-xs text-gray-600">
                    Global tech market cap reduction
                  </div>
                </div>
              </div>
            </div>
          ...
          <p className="text-gray-600">
            DeepSeek-R1 is a <strong>game-changer</strong> that{" "}
            <strong>rewrites the rules</strong> of{" "}
            <strong>AI development</strong>, <strong>cost structures</strong>,
            and <strong>global competition</strong>. It forces{" "}
            <strong>tech giants</strong> to adapt quickly or risk{" "}
            <strong>obsolescence</strong>, while{" "}
            <strong>governments scramble</strong> to assess its{" "}
            <strong>security risks</strong>. The <strong>AI race</strong> is no
            longer just about <strong>capability</strong>—it’s now about{" "}
            <strong>access, cost, and control</strong>. This shift accelerates{" "}
            <strong>open-source adoption</strong>, reshapes{" "}
            <strong>AI investment strategies</strong>, and intensifies{" "}
            <strong>geopolitical tensions</strong> over{" "}
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600 mb-4">
            DeepSeek, officially known as Hangzhou DeepSeek Artificial
            Intelligence Basic Technology Research Co., Ltd., is a Chinese
            artificial intelligence company based in Hangzhou, Zhejiang
            Province. Founded in 2023 by entrepreneur Liang Wenfeng, the company
            specializes in developing open-source large language models (LLMs).
          </p>

          <h3 className="text-xl font-bold text-gray-900 mb-2">Background:</h3>
          <p className="text-gray-600 mb-4">
            Before establishing DeepSeek, Liang Wenfeng co-founded the hedge
            fund High-Flyer in 2016, focusing on AI-driven trading algorithms.
            By 2021, High-Flyer exclusively utilized AI for trading. In April
            2023, High-Flyer initiated an artificial general intelligence lab
            dedicated to AI research, which evolved into DeepSeek in May 2023.
            The company is solely funded by High-Flyer.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3 text-gray-600 mb-4">
            <li>
              <strong>DeepSeek-Coder (November 2023):</strong> An open-source
              model designed for coding tasks, marking the company's initial
              foray into AI model development.
            </li>
            <li>
              <strong>DeepSeek-LLM Series (November 2023):</strong> Released
              models with 7B and 67B parameters in both 'Base' and 'Chat' forms,
              developed to compete with other LLMs available at the time.
            </li>
            <li>
              <strong>DeepSeek-R1 (January 2025):</strong> A significant
              advancement, this model was developed at a fraction of the cost of
              comparable models and required only a tenth of the computing
              power. Upon its release, DeepSeek-R1 quickly surpassed ChatGPT as
              the most-downloaded free app on the U.S. iOS App Store, leading to
              a notable 18% drop in Nvidia's share price.
            </li>
          </ul>
          ...
          <p className="text-gray-600 mb-4">
            DeepSeek's models have been recognized for their efficiency and
            performance, challenging the notion that only large tech firms with
            vast financial resources can dominate the AI field. The company's
            open-source approach has fostered collaborative innovation,
            potentially challenging current U.S. AI export limitations.
          </p>
          <p className="text-gray-600 mb-4">
            The company's success has disrupted the stock market, with notable
            dips in tech stocks, including Nvidia. DeepSeek's R1 model is more
            cost-effective for users, potentially pressuring U.S. companies'
            margins and investment incentives.
          </p>
          <p className="text-gray-600 mb-4">
            DeepSeek's emergence underscores China's growing capabilities in AI
            technology, highlighting the nation's potential to compete with the
            U.S. in AI advancements.
          </p>
          <p className="text-gray-600">
            Through its innovative approaches and rapid development, DeepSeek
            has positioned itself as a significant player in the global AI
            landscape.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="w-full">
          <div className="w-full p-6 bg-white rounded-xl shadow-lg">
            ...
            <p className="text-gray-600 mb-4">
              Interactive visualization of key stakeholders and their
              relationships. Drag nodes to reposition, click to unpin, and
              scroll to zoom.
            </p>
            <NetworkGraph />
          </div>
      ...
      <div className="bg-blue-100 p-8 border-b border-gray-200 mb-6">
        ...
        <p className="text-gray-600 text-lg">
          Exploring the dominant narratives shaping the DeepSeek-R1
          story—technological breakthroughs, market upheaval, backlash,
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <h4 className="text-sm font-semibold mb-4">
          Phases and Thematic Clusters of DeepSeek-R1's Impact
        </h4>
