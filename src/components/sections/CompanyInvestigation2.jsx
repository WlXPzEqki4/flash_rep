...
const CompanyInvestigation = ({ bottomSpace = 'mb-24' }) => {
  ...
  useEffect(() => {
    ...
    mapRef.current = new mapboxgl.Map({
      container: mapContainerRef.current,
      style: 'mapbox://styles/mapbox/streets-v12',
      center: [55.40013385682388, 25.29065286825747], // [longitude, latitude]
      zoom: 15.5,
      pitch: 25
    });
  ...
  const sections = [
    ...
    {
      id: 'communications',
      title: 'Afaq Almustqbal Transport LLC',
      content: '',
      details: [
        // 'Primary: +971 555659713, +971507371729',
        // 'Secondary: +971 50 560 6096, +971 50 221 5593',
      ...
      <CardContent className="!bg-[#101827] p-6">
        ...
        <div className="flex items-center mb-8">
            ...
            <h2 className="text-5xl font-bold text-white">
                Company Investigation: Afaq Al Mustqbal Transport LLC
            </h2>
            </div>
        ...
        <table className="w-full">
          ...
          <div className="flex-1">
            ...
            <div className={`${INTERMEDIATE_BLUE} p-8 rounded-md space-y-8`}>
              ...
              <div className="bg-[#374051] p-4 rounded-lg border border-gray-600">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!4v1738740550227!6m8!1m7!1sktUzfHbYzBNgAxo91N2H3g!2m2!1d25.28994784038657!2d55.40007915234877!3f18.660771242239605!4f-1.8355694055305918!5f0.7820865974627469"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
